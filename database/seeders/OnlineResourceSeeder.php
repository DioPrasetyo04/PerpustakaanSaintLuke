...
class OnlineResourceSeeder extends Seeder
{
    public function run(): void
    {
        $resources = [
            ...
            ['title' => 'Indonesia Heritage Society Library', 'type' => 'Riset', 'format' => 'Eksternal', 'tag' => 'Sejarah', 'color' => '#13322F', 'url' => 'https://www.heritagejkt.org', 'description' => 'Sumber riset sejarah dan budaya Indonesia untuk pelajar tingkat lanjut.'],
            ['title' => 'Britannica School', 'type' => 'Ensiklopedi', 'format' => 'Eksternal', 'tag' => 'Referensi', 'color' => '#3A2B14', 'url' => 'https://school.eb.com', 'description' => 'Ensiklopedi akademik yang disesuaikan untuk tiga jenjang: SD, SMP, SMA.'],
            ...
            ['title' => 'OpenStax Textbooks', 'type' => 'E-Book', 'format' => 'Web', 'tag' => 'Pelajaran', 'color' => '#3A1530', 'url' => 'https://openstax.org', 'description' => 'Buku teks terbuka untuk pelajaran sains dan ilmu sosial tingkat menengah-atas.'],
        ];
