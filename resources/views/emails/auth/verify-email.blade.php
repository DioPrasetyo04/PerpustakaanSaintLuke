<x-emails.auth-layout
    ...
    preheader="Satu langkah lagi — verifikasi email Anda untuk mengaktifkan akun Saint Luke E-Library."
>
    <div style="text-align:center; margin-bottom:8px;">
        <span style="display:inline-block; font-size:34px; line-height:1; padding:16px; background:#e6f4ee; border-radius:50%;">✉️</span>
    </div>

    <h2 style="margin:18px 0 6px; font-size:22px; font-weight:700; color:#14201b; text-align:center;">Halo, {{ $user->name }}! 👋</h2>
    <p style="margin:0 0 20px; font-size:15px; line-height:1.7; color:#4b5a52; text-align:center;">
        Terima kasih telah mendaftar. Untuk mulai meminjam buku dan menyimpan koleksi favorit,
    ...
    <div style="background:#f3ead2; border:1px solid #d2a653; border-radius:12px; padding:14px 18px; margin-bottom:20px;">
        <p style="margin:0; font-size:13px; line-height:1.6; color:#7a5b1c;">
            ⏳ Tautan ini hanya berlaku selama <strong>60 menit</strong>. Jika kedaluwarsa, Anda dapat meminta tautan baru dari halaman verifikasi.
        </p>
    </div>
    ...
    <p style="margin:0; font-size:12px; line-height:1.6; color:#9a988b;">
        Anda menerima email ini karena ada pendaftaran akun menggunakan alamat email ini.
